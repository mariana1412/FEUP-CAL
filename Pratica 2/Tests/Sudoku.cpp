...
void Sudoku::markSquare(int i, int j, int n, bool mark) {
    ...
    block3x3HasNumber[i/3][j/3][n] = mark;
    columnHasNumber[j][n] = mark;
    lineHasNumber[i][n] = mark;
}

bool Sudoku::isPossible(int i, int j, int n){
